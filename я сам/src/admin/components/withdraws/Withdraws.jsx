    ...
    return (
        <div className="w-full">
                <div className="bg-[#17181c] p-[20px] inline-flex flex-col gap-[10px] rounded-[16px] w-full text-white">
                    <h2 className="text-[#33a0ad] mb-[10px] text-[20px] font-semibold">Withdraws  list</h2>
                <div className="grid grid-cols-8 px-[20px] border-b-[1px] border-[#1e2126] pb-[10px]">
                    <span >ID</span>
                    <span >STATUS</span>
                    <span >USER</span>
                    <span>COIN</span>
                ...
                <div className="grid grid-cols-8 px-[20px] items-center">
                    <span >6565</span>
